...
const ViewApplications = () => {
  const {
    ...
    changeInterviewStatus, //  new API function for interview toggle
    changeOnboardingStatus, //  new API function for onboarding toggle
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <label className="relative inline-block w-12 h-6">
                      <input
                        ...
                        // Call changeInterviewStatus API from context
                        onChange={async () => {
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <label className="relative inline-block w-12 h-6">
                      <input
                        type="checkbox"
                        className="opacity-0 w-0 h-0"
                        //  Call changeOnboardingStatus API from context
                        onChange={async () => {
                        ...
                        onChange={async () => {
                          const newStatus =
                            data.status === "Accepted"
                              ? "Rejected"
                              : "Accepted";
                          await changeJobApplicationStatus(data._id, newStatus); //  call  function
                        }}
